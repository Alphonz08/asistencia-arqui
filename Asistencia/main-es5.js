...
var AlumnosComponent = /** @class */ (function () {
    function AlumnosComponent(customerService) {
        this.customerService = customerService;
        this.getAllCustomers();
    }
    AlumnosComponent.prototype.ngOnInit = function () {
    };
    AlumnosComponent.prototype.getAllCustomers = function () {
        var _this = this;
    ...
    AlumnosComponent.prototype.deleteCustomer = function (id) {
        var _this = this;
        this.customerService.deleteCustomer(id).subscribe(function (response) {
            _this.getAllCustomers();
        });
    };
    AlumnosComponent.ctorParameters = function () { return [
...
var AsignarComponent = /** @class */ (function () {
    function AsignarComponent(customerService, rfidService, router, activatedRoute) {
        this.customerService = customerService;
    ...
    AsignarComponent.prototype.getAllCustomers = function () {
        var _this = this;
        this.customerService.getUnassigned().subscribe(function (response) {
            _this.Customers = response;
        });
    };
    AsignarComponent.prototype.getAllRfids = function () {
        var _this = this;
        this.rfidService.getUnassigned().subscribe(function (response) {
            _this.Rfids = response;
        });
    };
    AsignarComponent.prototype.selectCustomer = function (id) {
        var _this = this;
        console.log(id);
        this.customerService.getCustomerById(id).subscribe(function (response) {
            _this.customerName = id;
            _this.customerSelect = true;
        });
    };
    AsignarComponent.prototype.selectRfid = function (serial) {
        var _this = this;
        this.rfidService.getRfidById(serial).subscribe(function (response) {
            _this.rfidSerial = serial;
            _this.rfidSelect = true;
        });
    };
    AsignarComponent.prototype.removeCustomer = function () {
        this.customerSelect = false;
        console.log('Alumno Removido');
    };
    AsignarComponent.prototype.removeRfid = function () {
        this.rfidSelect = false;
        console.log('Rfid Removido');
    };
    AsignarComponent.prototype.asignar = function (customerName, rfidSerial) {
    ...
    AsignarComponent.ctorParameters = function () { return [
        { type: _services_customer_customer_service__WEBPACK_IMPORTED_MODULE_2__["CustomerService"] },
...
var CreateAlumnoComponent = /** @class */ (function () {
    function CreateAlumnoComponent(customerService, router) {
        this.customerService = customerService;
        this.router = router;
        this.customer = {
            name: null,
    ...
    CreateAlumnoComponent.prototype.ngOnInit = function () {
    };
    CreateAlumnoComponent.prototype.createCustomer = function () {
        var _this = this;
        this.customerService.createCustomer(this.customer).subscribe(function (response) {
            console.log('Alumno Creado');
            _this.router.navigateByUrl('/customers');
        });
    };
    CreateAlumnoComponent.ctorParameters = function () { return [
        { type: _services_customer_customer_service__WEBPACK_IMPORTED_MODULE_2__["CustomerService"] },
...
var CreateRfidComponent = /** @class */ (function () {
    function CreateRfidComponent(rfidService, router) {
        this.rfidService = rfidService;
        this.router = router;
        this.rfid = {
            serial: null,
    ...
    CreateRfidComponent.prototype.ngOnInit = function () {
    };
    CreateRfidComponent.prototype.createRfid = function () {
        var _this = this;
        this.rfidService.createRfid(this.rfid).subscribe(function (response) {
            console.log('Rfid Creado');
            _this.router.navigateByUrl('/rfids');
        });
    };
    CreateRfidComponent.ctorParameters = function () { return [
...
var EditAlumnoComponent = /** @class */ (function () {
    function EditAlumnoComponent(customerService, router, activatedRoute) {
        this.customerService = customerService;
        this.router = router;
        this.activatedRoute = activatedRoute;
        this.customer = {
    ...
    EditAlumnoComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        if (this.id) {
            ...
            this.customerService.getCustomers().subscribe(function (response) {
                _this.customers = response;
                _this.customer = _this.customers.find(function (m) {
                    return m.id == _this.id;
                });
            });
        }
        else {
    ...
    EditAlumnoComponent.prototype.updateCustomer = function () {
        var _this = this;
        if (this.edit) {
            this.customerService.updateCustomer(this.customer).subscribe(function (response) {
                console.log('Alumno Actualizado');
                _this.router.navigateByUrl('/customers');
            });
        }
    };
    EditAlumnoComponent.ctorParameters = function () { return [
        { type: _services_customer_customer_service__WEBPACK_IMPORTED_MODULE_2__["CustomerService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
...
var EditRfidComponent = /** @class */ (function () {
    function EditRfidComponent(rfidService, router, activatedRoute) {
        this.rfidService = rfidService;
        this.router = router;
        this.activatedRoute = activatedRoute;
        this.rfid = {
    ...
    EditRfidComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.id = this.activatedRoute.snapshot.params['id'];
        if (this.id) {
            this.edit = true;
            this.rfidService.getRfid().subscribe(function (response) {
                _this.rfids = response;
                _this.rfid = _this.rfids.find(function (m) {
                    return m.id == _this.id;
                });
            });
        }
    ...
    EditRfidComponent.prototype.updateRfid = function () {
        var _this = this;
        if (this.edit) {
            this.rfidService.updateRfid(this.rfid).subscribe(function (response) {
                console.log('Rfid Actualizado');
                _this.router.navigateByUrl('/rfids');
            });
        }
    };
    EditRfidComponent.ctorParameters = function () { return [
        { type: _services_rfid_rfid_service__WEBPACK_IMPORTED_MODULE_2__["RfidService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }
    ]; };
...
var RfidsComponent = /** @class */ (function () {
    function RfidsComponent(rfidService) {
        this.rfidService = rfidService;
        this.getAllRfids();
    }
    RfidsComponent.prototype.ngOnInit = function () {
    };
    RfidsComponent.prototype.getAllRfids = function () {
        var _this = this;
        this.rfidService.getRfid().subscribe(function (response) {
            _this.Rfids = response;
        });
    };
    RfidsComponent.prototype.deleteRfid = function (id) {
        var _this = this;
        this.rfidService.deleteRfid(id).subscribe(function (response) {
            _this.getAllRfids();
        });
    };
    RfidsComponent.ctorParameters = function () { return [
        { type: _services_rfid_rfid_service__WEBPACK_IMPORTED_MODULE_2__["RfidService"] }
    ]; };
...
var CustomerService = /** @class */ (function () {
    ...
    CustomerService.prototype.getUnassigned = function () {
